...
if (isset($_POST['madena'])) {
  $colname_Recordset1 = $_POST['madena'];
}
mysql_select_db($database_utopia, $utopia);
$query_Recordset1 = sprintf("SELECT * FROM udata WHERE madena = %s ORDER BY update_date DESC", GetSQLValueString($colname_Recordset1, "text"));
...
mysql_select_db($database_utopia, $utopia);
$query_Recordset2 = "SELECT distinct madena FROM udata";
...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="22%" align="center" valign="middle" bgcolor="#FFFEBF" class="blue"><strong>شاشة البحث بالمدينة</strong></td>
      ...
      <table width="77%" border="0" align="center">
        <tr>
          ...
          <td width="5%"><label for="code"></label>
            ...
            <select name="madena" id="madena">
              <?php
do {  
?>
              <option value="<?php echo $row_Recordset2['madena']?>"<?php if (!(strcmp($row_Recordset2['madena'], $_SESSION['madena']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset2['madena']?></option>
              <?php
...
?>
          ...
          <td width="39%" class="gr"><strong>اختر المدينة لعرض العقارات</strong></td>
        </tr>
        <tr>
    ...
    <table width="95%" border="0" align="center">
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#666666" class="black"><table width="20%" border="0">
          <tr class="yelow">
            <td align="center" valign="middle"><a href="./print_sheet.php?code=<?php echo $row_Recordset1['code']; ?>"><img src="./print-icon.png" alt="rre" width="70" height="28" /></a></td>

...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="18%" align="center" valign="middle" bgcolor="#FFFEBF" class="blue"><strong>شاشة البحث بالمرحلة</strong></td>
    ...
    <td colspan="2"><form id="form1" name="form1" method="post" action="">
      <table width="77%" border="0" align="center">
        <tr>
          ...
          <td width="22%"><label for="marhala"></label>
            <input name="marhala" type="text" id="marhala" value="<?php echo $_SESSION['marhala']; ?>" size="50" /></td>
          <td width="22%" class="gr"><strong>اختر المرحلـــــة</strong></td>
        </tr>
        <tr>

...
if (isset($_POST['cust_name'])) {
  $colname_Recordset1 = $_POST['cust_name'];
}
$query_Recordset1 = "SELECT * FROM udata WHERE cust_name LIKE ? ORDER BY update_date DESC";
...
if (isset($_GET['totalRows_Recordset1'])) {
  $totalRows_Recordset1 = $_GET['totalRows_Recordset1'];
    ...
    $count_query = "SELECT COUNT(*) FROM udata WHERE cust_name LIKE ?";
...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="22%" align="center" valign="middle" bgcolor="#FFFEBF" class="blue"><strong>شاشة البحث ببيانات العميل</strong></td>
    <td width="6%" align="right" valign="middle" bgcolor="#FFFEBF"><a href="<?php echo $logoutAction ?>"><img src="logout.png" width="28" height="28" /></a></td>
  </tr>
  <tr>
    <td colspan="2"><form id="form1" name="form1" method="post" action="">
      <table width="77%" border="0" align="center">
        <tr>
          ...
          <td width="1%">&nbsp;</td>
          <td width="38%">&nbsp;</td>
          <td width="6%" align="right" valign="middle"><input type="submit" name="search" id="search" value="بحث" /></td>
          <td width="15%" align="center" valign="middle"><label for="code"></label>
            <label for="namozg"><span id="sprytextfield1">
              <input name="cust_name" type="text" id="cust_name" tabindex="1" value="<?php echo $_SESSION['cust_name']; ?>" />
  </span></label></td>
          <td width="32%" align="left" valign="middle" class="gr"><strong>اسم العميل</strong></td>
        </tr>
        <tr>

...
$query_Recordset1 = "SELECT * FROM udata WHERE momz=1 ORDER BY update_date DESC, udata.cust_name ASC";
$stmt = $pdo->prepare($query_Recordset1 . " LIMIT ?, ?");
$stmt->execute([$startRow_Recordset1, $maxRows_Recordset1]);
...
<title>استعلام العقارات المميزة</title>
<style type="text/css">
body,td,th {
	color: #17036B;
}
...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="20%" align="center" valign="middle" bgcolor="#FFFEBF" class="blue"><strong>كافة بيانات العقارات المميزة</strong></td>
  ...
  <tr>
    <td colspan="3" align="center" valign="middle" bgcolor="#CCCCCC"><hr /></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
      <table width="95%" border="0" align="center">
        <tr class="gr">
          <td colspan="3" rowspan="10" align="center" valign="middle">&nbsp;</td>
          <td width="10%" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong class="yelow">استـــــــــــلام</strong></td>
          <td width="9%" colspan="2" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong class="yelow">الدور</strong></td>
          <td width="8%" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong class="yelow">المرحلـــــــــة</strong></td>
          <td width="10%" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong class="yelow">الحـــــــــتالة</strong></td>
        ...
        <tr class="black">
          ...
          <td colspan="2" align="center" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo $row_Recordset1['door']; ?></td>
        ...
        <tr>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>حجـــــــــــز</strong></td>
          <td colspan="2" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>الوديعة</strong></td>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>النـــــــــــادى</strong></td>
        ...
        <tr>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>View</strong></td>
          <td colspan="2" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>مدة الايجــــــار</strong></td>
          ...
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>المتبقى</strong></td>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>المدفوع</strong></td>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>أوفـــــــتر</strong></td>
        ...
        <tr>
          ...
          <td colspan="2" align="center" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo $row_Recordset1['modah_ejar']; ?></td>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="yelow"><span class="black"><?php echo $row_Recordset1['kest_modah']; ?></span></td>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="yelow"><span class="black"><?php echo number_format($row_Recordset1['kest_month']); ?></span></td>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo number_format($row_Recordset1['kest_year']); ?></td>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo $row_Recordset1['motabaqi']; ?></td>
        ...
        <tr>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="black"><span class="black"><?php echo $row_Recordset1['entry_date']; ?></span></td>
          <td colspan="2" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>تاريخ الادخال</strong></td>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="black"><span class="black"><?php echo $row_Recordset1['modkhel']; ?></span></td>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>مدخل البيانات</strong></td>
          <td colspan="5" align="right" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo $row_Recordset1['address']; ?></td>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>العنـــــــوان</strong></td>
        </tr>
        <tr>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="black"><span class="black"><?php echo $row_Recordset1['update_date']; ?></span></td>
          <td colspan="2" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>تاريخ التعديل</strong></td>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo $row_Recordset1['updater']; ?></td>
          <td colspan="7" align="left" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>آخر تعديل بواسطة</strong></td>
          </tr>
        <tr>
          <td colspan="3" align="center" valign="middle" bgcolor="#F0EDEE" class="gr"><strong class="yelow">العمليات المتاحة</strong></td>
          <td rowspan="2" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow">&nbsp;</td>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="yelow"><span class="black"><?php echo $row_Recordset1['mobile']; ?></span></td>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>موبايــــــــل</strong></td>
          <td width="10%" align="center" valign="middle" bgcolor="#FFFFFF" class="yelow"><span class="black"><?php echo $row_Recordset1['telephone']; ?></span></td>
          <td width="9%" align="center" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>تليفـــــــــون</strong></td>
          ...
          <td align="right" valign="middle" bgcolor="#F0EDEE" class="yelow"><strong>اســــــم العمـــــــيل</strong></td>
        </tr>
        <tr>
          <td align="center" valign="middle" bgcolor="#666666" class="black"><table width="20%" border="0">
            <tr class="yelow">
              <td align="center" valign="middle"><a href="./print_sheet.php?code=<?php echo $row_Recordset1['code']; ?>" target="_new"><img src="./print-icon.png" alt="ewre" width="28" height="28" title="طباعة التفاصيل" /></a></td>
          ...
          <td align="center" valign="middle" bgcolor="#666666" class="black"><a href="update.php?code=<?php echo $row_Recordset1['code'];?>"><img src="alarm.jpg" width="40" height="40" alt=""/></a></td>
          <td align="center" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo $row_Recordset1['motabaa']; ?></td>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="black"><span class="yelow"><strong>المتـــــــابعة</strong></span></td>
          <td align="right" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo $row_Recordset1['masdr']; ?></td>
          <td align="center" valign="middle" bgcolor="#F0EDEE" class="black"><span class="yelow"><strong>المصـــــــدر</strong></span></td>
          <td colspan="2" align="right" valign="middle" bgcolor="#FFFFFF" class="black"><?php echo $row_Recordset1['notes']; ?></td>
          <td align="right" valign="middle" bgcolor="#F0EDEE" class="yelow"><span class="black"><strong class="yelow">ملاحظــــــــــــــــات</strong></span></td>
        </tr>
        <tr>
          <td colspan="14"><hr /></td>
        </tr>

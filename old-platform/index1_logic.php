...
if (!isset($_SESSION)) {
  session_start();
  $_SESSION['code'] = $_POST['code'] ?? null;
  $_SESSION['aqar_type'] = $_POST['aqar_type'] ?? null;
  $_SESSION['amalya_type'] = $_POST['amalya_type'] ?? null;
  $_SESSION['tashteeb'] = $_POST['tashteeb'] ?? null;
  $_SESSION['door'] = $_POST['door'] ?? null;
  $_SESSION['geem'] = $_POST['geem'] ?? null;
  $_SESSION['ain'] = $_POST['ain'] ?? null;
  $_SESSION['wow'] = $_POST['wow'] ?? null;
  $_SESSION['mobile'] = $_POST['mobile'] ?? null;
  $_SESSION['cust_name'] = $_POST['customer_name'] ?? null;
  $_SESSION['madena'] = $_POST['madena'] ?? null;
  $_SESSION['marhala'] = $_POST['marhala'] ?? null;
  $_SESSION['namozg'] = $_POST['namozag'] ?? null;
  $_SESSION['price_from'] = $_POST['price_from'] ?? null;
  $_SESSION['price_to'] = $_POST['price_to'] ?? null;
  $_SESSION['mesaha_from'] = $_POST['mesaha_from'] ?? null;
  $_SESSION['mesaha_to'] = $_POST['mesaha_to'] ?? null;
  $_SESSION['status'] = $_POST['status'] ?? null;
}

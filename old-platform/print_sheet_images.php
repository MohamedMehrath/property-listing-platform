<?php require_once('print_sheet_images_logic.php'); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>طباعة تفاصيل العقار بالصور</title>
<style type="text/css">
body,td,th {
	color: #17036B;
	font-weight: normal;
...
<table width="99%" border="0" align="center">
  <tbody>
    <tr>
      ...
      <td align="center" valign="middle"><strong style="color: #17036B; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><span class="yelow">كشف تفاصيل بيانات العقار </span></strong></td>
...
<table width="99%" border="0" align="center">
  <tbody>
    <tr>
      ...
      <td align="right" valign="middle" bgcolor="#FFFEDC"><strong style="color: #17036B; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><span class="yelow">بيانــــــات العقــــــار الأساســــية</span></strong></td>
      <td width="4%"><img src="searching-for-a-house.png" width="39" height="35" alt=""/></td>
    </tr>
    <tr>
      <td colspan="4"><table width="80%" border="0" align="right">
        <tbody>
          <tr>
...
<table width="99%" border="0" align="center">
  <tbody>
    <tr>
      <td width="19%" align="right" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="middle" bgcolor="#FFFEDC" style="font-size: 16pt"><strong style="color: #17036B; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><span class="yelow">البيـانـــــات الثانـــــــوية</span></strong></td>
      <td width="4%"><img src="aqarr.jpg" width="42" height="42" alt=""/></td>
    </tr>
    <tr>
      <td colspan="2"><table width="80%" border="0" align="right">
        <tbody>
          <tr>
            <td width="10%" align="center" bgcolor="#FFFFFF">&nbsp;</td>
...
<table width="99%" border="0" align="center">
  <tbody>
    <tr>
      <td width="19%" align="right" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="middle" bgcolor="#FFFEDC" style="font-size: 16pt"><strong style="color: #17036B; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><span class="yelow">البيـانـــــات المـــالــــــية</span></strong></td>
      <td width="4%"><img src="money.png" width="45" height="46" alt=""/></td>
    </tr>
    <tr>
      <td colspan="2"><table width="80%" border="1" align="right" cellpadding="0" cellspacing="0" bordercolor="#327900">
        <tbody>
          <tr>
        ...
        <table width="80%" border="0" align="right">
          <tbody>
            <tr>
              <td width="100%"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#327900">
                <tbody>
                  <tr>
...
<table width="99%" border="0" align="center">
  <tbody>
    <tr>
      <td width="19%" align="right" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="middle" bgcolor="#FFFEDC" style="font-size: 16pt"><strong style="color: #17036B; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><span class="yelow">بيانــــــات الادخال والمتابعــة</span></strong></td>
      <td width="4%"><img src="dataentry.jpg" width="50" height="46" alt=""/></td>
    </tr>
    <tr>
      <td colspan="2"><table width="80%" border="0" align="right">
        <tbody>
        ...
        <table width="80%" border="0" align="right">
          <tbody>
            ...
            <tr>
              ...
              <td width="5%" align="right" bgcolor="#F5F3F4"><strong class="yelow"><a href="./print_sheet_new.phpcode=<?php echo $row_Recordset1['code']; ?>">رجــــوع</a></strong></td>
              <td width="9%" align="center" bgcolor="#F5F3F4"><a href="print_sheet_images.php?code=<?php echo $row_Recordset1['code']; ?>" target="_blank"><strong>بيانات العقار بالصور</strong></a></td>
              <td width="7%" align="right" bgcolor="#F5F3F4"><a href="update.php?code=<?php echo $row_Recordset1['code'];?>"><img src="alarm.jpg" width="40" height="40" alt=""/></a></td>
            ...
            <tr>
              <td colspan="4" align="center" valign="middle"><a href="<?php echo $row_Recordset2['image3']; ?>" target="_blank">
              <img src="<?php echo $row_Recordset2['image3']; ?>" /></a></td>
              <td align="center" valign="middle"><a href="<?php echo $row_Recordset2['image2']; ?>" target="_blank">
              <img src="<?php echo $row_Recordset2['image2']; ?>" /></a></td>
              <td align="center" valign="middle"><a href="<?php echo $row_Recordset2['image1']; ?>" target="_blank">
              <img src="<?php echo $row_Recordset2['image1']; ?>" /></a></td>
            </tr>
            <tr>

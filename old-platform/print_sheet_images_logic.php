...
$stmt1->execute([$colname_Recordset1]);
$Recordset1 = $stmt1->fetchAll(PDO::FETCH_ASSOC);
$row_Recordset1 = $Recordset1[0] ?? null;

$all_Recordset1 = $pdo->prepare($query_Recordset1);
$all_Recordset1->execute([$colname_Recordset1]);
$totalRows_Recordset1 = $all_Recordset1->rowCount();

$totalPages_Recordset1 = ceil($totalRows_Recordset1/$maxRows_Recordset1)-1;

$query_Recordset2 = "SELECT * FROM udata_images";
$stmt2 = $pdo->prepare($query_Recordset2);
$stmt2->execute();
$Recordset2 = $stmt2->fetchAll(PDO::FETCH_ASSOC);
$row_Recordset2 = $Recordset2[0] ?? null;
$totalRows_Recordset2 = $stmt2->rowCount();

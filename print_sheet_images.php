...
mysql_select_db($database_goodnews1, $goodnews1);
$query_Recordset2 = "SELECT * FROM udata_images";
        ...
        <table width="80%" border="0" align="right">
          <tbody>
            ...
            <tr>
              ...
              <td width="9%" align="center" bgcolor="#F5F3F4"><a href="view_images_code.php?code=<?php echo $row_Recordset1['code']; ?>" target="_blank"><strong>صور العقار</strong></a></td>

...
$query_Recordset1 = "SELECT * FROM udata where remember = 1 ORDER BY update_date DESC, udata.cust_name ASC";
...
<title>تنبيه متابعة العقارات</title>
<style type="text/css">
body,td,th {
	color: #17036B;
}
...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="20%" align="center" valign="middle" bgcolor="#FFFEBF" class="blue"><strong>متابعة العقارات الهامة والتى لها خاصية التنبيه</strong></td>
      ...
      <table width="95%" border="0" align="center">
        ...
        <tr>
          <td align="center" valign="middle" bgcolor="#666666" class="black"><table width="20%" border="0">
            <tr class="yelow">
              <td align="center" valign="middle"><a href="./print_sheet.php?code=<?php echo $row_Recordset1['code']; ?>" target="_new"><img src="./print-icon.png" alt="ewre" width="70" height="28" /></a></td>
          ...
          <td align="center" valign="middle" bgcolor="#666666" class="black">
          <a href="update.php?code=<?php echo $row_Recordset1['code'];?>"><img src="alarm.jpg" width="40" height="40" alt=""/></a></td>

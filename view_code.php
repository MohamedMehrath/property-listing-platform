...
if (isset($_GET['totalRows_Recordset1'])) {
  $totalRows_Recordset1 = $_GET['totalRows_Recordset1'];
    ...
    $count_query = "SELECT COUNT(*) FROM udata WHERE code = ?";
...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="18%" align="center" valign="middle" bgcolor="#FFFEBF" class="blue"><strong>شاشة البحث بكود العقار</strong></td>
    ...
    <td colspan="2"><form id="form1" name="form1" method="post" action="">
      <table width="82%" border="0" align="center">
        <tr>
          ...
          <td width="22%"><label for="code"></label>
            <input name="code" type="text" id="code" tabindex="1" value="<?php echo $_SESSION['code']; ?>" size="50" /></td>
          <td width="22%" class="gr"><strong>ادخل كود العقار</strong></td>
        </tr>
        <tr>
          <td colspan="6" bgcolor="#FFFFFF"><hr /><p align="right">نتيجة البحث عن كود العقار<?php echo htmlspecialchars($colname_Recordset1, ENT_QUOTES, 'UTF-8'); ?>...</p> </td>
          </tr>
      </table>
    </form></td>
    ...
    <table width="95%" border="0" align="center">
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#666666" class="black"><table width="20%" border="0">
          <tr class="yelow">
            <td align="center" valign="middle"><a href="./print_sheet.php?code=<?php echo $row_Recordset1['code']; ?>"><img src="./print-icon.png" alt="we" width="70" height="28" /></a></td>

...
if (isset($_POST['aqar_type'])) {
  $colname_Recordset1 = $_POST['aqar_type'];
}
$query_Recordset1 = "SELECT * FROM udata WHERE aqar_type = ? ORDER BY update_date DESC";
$stmt = $pdo_utopia->prepare($query_Recordset1 . " LIMIT ?, ?");
...
if (isset($_GET['totalRows_Recordset1'])) {
  $totalRows_Recordset1 = $_GET['totalRows_Recordset1'];
    ...
    $count_query = "SELECT COUNT(*) FROM udata WHERE aqar_type = ?";
    $stmt_total = $pdo_utopia->prepare($count_query);
    $stmt_total->execute([$colname_Recordset1]);
    $totalRows_Recordset1 = $stmt_total->fetchColumn();
}
$totalPages_Recordset1 = ceil($totalRows_Recordset1/$maxRows_Recordset1)-1;

$query_Recordset2 = "SELECT distinct aqar_type FROM udata";
$Recordset2 = $pdo_goodnews1->query($query_Recordset2)->fetchAll();
...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="16%" align="center" valign="middle" bgcolor="#FFFEBF" class="blue"><strong>شاشة البحث بنوع العقار</strong></td>
      ...
      <table width="77%" border="0" align="center">
        <tr>
          ...
          <td width="5%"><label for="code"></label>
            ...
            <select name="aqar_type" id="aqar_type">
              <?php foreach($Recordset2 as $row_Recordset2): ?>
              <option value="<?php echo $row_Recordset2['aqar_type']?>"<?php if (!(strcmp($row_Recordset2['aqar_type'], $_SESSION['aqar_type']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset2['aqar_type']?></option>
              <?php endforeach; ?>
            </select></td>
          <td width="39%" class="gr"><strong>اختر نوع العقار</strong></td>
        </tr>
        <tr>
    ...
    <table width="95%" border="0" align="center">
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#666666" class="black"><table width="20%" border="0">
          <tr class="yelow">
            <td align="center" valign="middle"><a href="./print_sheet.php?code=<?php echo $row_Recordset1['code']; ?>"><img src="./print-icon.png" alt="er" width="70" height="28" /></a></td>

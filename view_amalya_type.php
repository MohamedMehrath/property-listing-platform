...
if (isset($_POST['amalya_type'])) {
  $colname_Recordset1 = $_POST['amalya_type'];
}
$query_Recordset1 = "SELECT * FROM udata WHERE amalya_type = ? ORDER BY update_date DESC";
...
if (isset($_GET['totalRows_Recordset1'])) {
  $totalRows_Recordset1 = $_GET['totalRows_Recordset1'];
    ...
    $count_query = "SELECT COUNT(*) FROM udata WHERE amalya_type = ?";
...
$query_Recordset2 = "SELECT distinct amalya_type FROM udata";
...
<table width="90%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="20%" align="center" valign="middle" bgcolor="#FFFEBF" class="blue"><strong>شاشة البحث بنوع العملية</strong></td>
    <td width="7%" align="right" valign="middle" bgcolor="#FFFEBF"><a href="<?php echo $logoutAction ?>"><img src="logout.png" width="28" height="28" /></a></td>
  </tr>
  <tr>
        ...
        <tr>
          ...
          <td width="5%"><label for="code"></label>
            ...
            <select name="amalya_type" id="amalya_type">
              ...
              <option value="<?php echo $row_Recordset2['amalya_type']?>"<?php if (!(strcmp($row_Recordset2['amalya_type'], $_SESSION['amalya_type']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset2['amalya_type']?></option>
              <?php endforeach; ?>
            </select></td>
          <td width="39%" class="gr"><strong>اختر نوع العملية</strong></td>
        </tr>
        <tr>
    ...
    <table width="95%" border="0" align="center">
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#666666" class="black"><table width="20%" border="0">
          <tr class="yelow">
            <td align="center" valign="middle"><a href="./print_sheet.php?code=<?php echo $row_Recordset1['code']; ?>"><img src="./print-icon.png" alt="re" width="70" height="28" /></a></td>
        ...
        <td align="right" valign="middle" bgcolor="#F0EDEE" class="yelow"><span class="black"><strong class="gr">ملاحظات</strong></span></td>
        </tr>
      <tr>
        <td colspan="13"><hr /></td>
        </tr>

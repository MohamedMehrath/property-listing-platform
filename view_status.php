...
if (isset($_POST['status'])) {
  $colname_Recordset1 = $_POST['status'];
}
mysql_select_db($database_utopia, $utopia);
$query_Recordset1 = sprintf("SELECT * FROM udata WHERE status = %s ORDER BY update_date DESC", GetSQLValueString($colname_Recordset1, "text"));
...
mysql_select_db($database_utopia, $utopia);
$query_Recordset2 = "SELECT distinct status FROM udata";
...
<table width="900" border="0" align="center">
  <tr>
    ...
    <iframe src="Banner.php" name="Banner" width="900" height="160" align="top" scrolling="no" frameborder="0" id="Banner">Banner</iframe></td>
  </tr>
  <tr>
    <td width="62%" align="right" valign="middle" bgcolor="#FFFEBF">&nbsp;</td>
    <td width="28%" align="center" valign="middle" bgcolor="#FFFEBF"><p><strong class="black">شاشة البحث بحالة العقار</strong></p></td>
    <td width="10%" align="right" valign="middle" bgcolor="#FFFEBF"><a href="<?php echo $logoutAction ?>"><img src="logout.png" width="28" height="28" /></a></td>
  </tr>
  <tr>
...
do {  
?>
              <option value="<?php echo $row_Recordset2['status']?>"<?php if (!(strcmp($row_Recordset2['status'], $_SESSION['status']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset2['status']?></option>
              <?php
...
?>
          ...
          <td width="39%" class="gr"><strong>اختر حالة العقار</strong></td>
        </tr>
        <tr>
  ...
  <tr>
    <td colspan="2" bgcolor="#FFFFFF"><table width="26%" border="0">
      <tr>
  ...
  <?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
    <table width="95%" border="0" align="center">
      <tr class="gr">
        ...
        <td width="8%" align="center" valign="middle" bgcolor="#F0EDEE" class="blue"><strong class="yelow">المرحلة</strong></td>
        <td width="10%" align="center" valign="middle" bgcolor="#F0EDEE" class="blue"><strong class="yelow">الحالة</strong></td>
        <td width="11%" align="center" valign="middle" bgcolor="#F0EDEE" class="blue"><strong class="yelow">التشطيب</strong></td>
        <td align="center" valign="middle" bgcolor="#F0EDEE" class="blue"><strong class="yelow">نوع العملية</strong></td>
        <td align="center" valign="middle" bgcolor="#F0EDEE" class="blue"><strong class="yelow">النموذج</strong></td>
        <td align="center" valign="middle" bgcolor="#F0EDEE" class="blue"><strong class="yelow">نوع العقار</strong></td>
        <td align="center" valign="middle" bgcolor="#F0EDEE" class="blue"><strong class="yelow">المدينة</strong></td>
        <td align="center" valign="middle" bgcolor="#F0EDEE" class="blue"><strong class="yelow">الكود</strong></td>
        </tr>
      <tr class="black">
      ...
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#F0EDEE" class="gr"><strong class="yelow">العمليات المتاحة</strong></td>
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#666666" class="black"><table width="20%" border="0">
          <tr class="yelow">
            <td align="center" valign="middle"><a href="./print_sheet.php?code=<?php echo $row_Recordset1['code']; ?>"><img src="./print-icon.png" alt="rtr" width="70" height="28" /></a></td>
  ...
  <tr>
    <td colspan="2"><table width="26%" border="0">
      <tr>
        <td bgcolor="#FFFFFF"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, $totalPages_Recordset1, $queryString_Recordset1); ?>">الاخير</a></td>
        <td bgcolor="#FFFFFF"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, max(0, $pageNum_Recordset1 - 1), $queryString_Recordset1); ?>">السابق</a></td>
        <td bgcolor="#FFFFFF"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, min($totalPages_Recordset1, $pageNum_Recordset1 + 1), $queryString_Recordset1); ?>">التالى</a></td>
